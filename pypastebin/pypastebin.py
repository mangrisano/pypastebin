...
class PyPastebin(object):
    ...
    def __init__(self, file=None, syntax=None, expires=None):
        """Constructor: see method docstring for info.

        If the argument 'file' is None, it defaults to 'sys.stdin'.
        If the argument 'syntax' is None, it defaults to 'text'.
        If the argument 'expires' is None, it defaults to '1'.
        """
    ...
    def get_url(self):
        """Get the url generated by the _generate_url() method."""

        self.url = self._generate_url()


    def print_url(self):
        """Print the url generated by the _generate_url() method."""
